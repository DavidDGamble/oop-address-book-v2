...
function handleDelete(event) {
  ...
  document.querySelector(".address").innerText = null;
  document.querySelector(".first-name").innerText = null;
  document.querySelector(".last-name").innerText = null;
  document.querySelector(".phone-number").innerText = null;
